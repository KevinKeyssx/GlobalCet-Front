			...
			<div class="space-y-6">
				<div class="space-y-3">
                    ...
                    <div class="space-y-2 text-sm font-semibold">
						<!-- WSP 1 -->
						<a href="https://wa.me/56996740021" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2 text-text transition-colors duration-200 hover:text-brand-bright">
                        ...
                        <!-- TEL -->
						<a href="tel:+56961157681" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2 text-text transition-colors duration-200 hover:text-brand-bright">
